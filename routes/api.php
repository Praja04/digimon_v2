...
Route::post('/blending-awal/update-nomor-blending', [App\Http\Controllers\Api\BlendingAwalController::class, 'updateNomorBlending'])->name('api.blending.awal.update_nomor_blending');
