                    ...
                    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Kelola master rekomendasi hasil sampling Packaging Material.
                            </p>
                        </div>
...
<div
    ...
    tabindex="-1"
    aria-labelledby="modalRecommendationLabel"
    aria-hidden="true"
>
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            class="form-control"
                            maxlength="50"
                            placeholder="Masukkan kode rekomendasi"
                        >
                        ...
                        <small class="text-muted">
                            Contoh: DITERIMA, TERIMA_BERSYARAT, DITOLAK, WIP.
                        </small>
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">
                            Contoh: Diterima, Terima Bersyarat, Ditolak, atau WIP.
                        </small>
...
<script>
    $(document).ready(function () {
        ...
        const modalRecommendation = new bootstrap.Modal(
            modalElement
        );
        ...
        const table = $('#datatable').DataTable({
            ...
            language: {
                ...
                emptyTable: 'Data Rekomendasi belum tersedia',
        ...
        $(document).on('click', '.btnEdit', function () {
            ...
            $.ajax({
                url: "{{ url('/recommendation') }}/" + id + "/edit",
                type: 'GET',
                dataType: 'json',
