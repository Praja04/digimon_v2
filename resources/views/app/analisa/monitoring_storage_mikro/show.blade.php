                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                        ...
                                        <tbody>
                                            @forelse ($productionBatch->monitoringStorageMikro as $monitoringStorageMikro)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($monitoringStorageMikro->hasil === 'OK')
                                                            <span class="badge bg-success">OK</span>
                                                        @elseif ($monitoringStorageMikro->hasil === 'NOT OK')
                                                            <span class="badge bg-danger">NOT OK</span>
                                                        @elseif ($monitoringStorageMikro->hasil === 'PENDING')
                                                    ...
                                                    <td>
                                                        @if (is_null($monitoringStorageMikro->ym))
                                                            <button class="btn btn-sm btn-primary" id="btnAnalisa"
                                                                monitoringStorageMikro-id="{{ $monitoringStorageMikro->id }}">Input
                                                                Analisa</button>
                                                        @else
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#btnAnalisa', function() {
                let monitoringStorageMikroId = $(this).attr('monitoringStorageMikro-id');
                ...
                // Set ID
                $('#id').val(monitoringStorageMikroId);
