                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('analisa.monitoring-storage-kimia.index') }}">Analisa
                                        Monitoring Storage Kimia</a></li>
                                ...
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            @forelse ($productionBatch->monitoringStorageKimia as $blending)
                                                @php
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title" id="detailModalLabel">Detail Data Monitoring Storage Kimia</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.open-blending-modal-edit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('analisa.monitoring-storage-kimia.edit', '') }}/" + id,
                    dataType: "json",
                    beforeSend: function() {
                        $('#form')[0].reset();
                        $('.text-danger').html('');
