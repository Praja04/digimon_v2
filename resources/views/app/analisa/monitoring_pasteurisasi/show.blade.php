...
@section('title', 'Analisa Monitoring Pasteurisasi')
@section('content')
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('analisa.monitoring-pasteurisasi.index') }}">Analisa
                                        Monitoring Pasteurisasi</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title" id="detailModalLabel">Detail Data Monitoring Pasteurisasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.open-pasteurisasi-modal-edit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('analisa.monitoring-pasteurisasi.edit', '') }}/" + id,
                    dataType: "json",
                    beforeSend: function() {
                        $('#form')[0].reset();
                        $('.text-danger').html('');
