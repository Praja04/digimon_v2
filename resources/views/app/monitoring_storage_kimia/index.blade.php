...
@section('title', 'Monitoring Storage Kimia')
@section('content')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('monitoring-storage-kimia.index') }}",
                    data: function(d) {
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('monitoring-storage-kimia.edit', '') }}/" + id,
                    dataType: "json",
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "{{ route('monitoring-storage-kimia.update') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
            ...
            $('body').on('click', '#btnDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "monitoring-storage-kimia/" + id,
                            dataType: "json",
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
