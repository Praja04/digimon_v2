        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'status_blending_awal',
                        name: 'status_blending_awal',
                        orderable: false,
                        searchable: false
                    },
                    {
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('blending-awal.edit', '') }}/" + id,
                    dataType: "json",
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "{{ route('blending-awal.update') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
