        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <h4 class="mb-sm-0">
                            Daftar Sampling Karton
                        </h4>

                        <p class="text-muted mb-0 mt-1">
                            Daftar SPB Karton dari Input Incoming.
                        </p>
                    </div>
                                                ...
                                                <td>
                                                    @if ($sudahSampling)
                                                        ...
                                                        <a
                                                            ...
                                                            title="Buka menu pemeriksaan Karton"
                                                        >
                                        ...
                                        @empty
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        Buat SPB Karton melalui Input Incoming terlebih dahulu.
                                                    </p>
                                                </td>
                                            </tr>
...
<style>
    ...
    .karton-loading::after {
        ...
        border-radius: 50%;
        animation: kartonSpin 0.8s linear infinite;
        z-index: 20;
    }

    @keyframes kartonSpin {
        to {
    ...
    function () {
        ...
        async function loadTable(
            ...
            try {
                ...
                if (!nextResultArea) {
                    throw new Error(
                        'Bagian tabel Karton tidak ditemukan.'
                    );
                }
