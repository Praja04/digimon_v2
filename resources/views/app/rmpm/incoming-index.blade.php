...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-end">
                        <div class="back-action-card">
                            ...
                            <a href="{{ route('rmpm.pm') }}" class="btn btn-primary px-4">
            ...
            <div id="editModeBanner" class="alert alert-warning border-0 shadow-sm d-none">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <button type="button" id="btnCancelEdit" class="btn btn-sm btn-outline-dark">
                ...
                <div class="col-12">
                    ...
                    <div class="card border-0 shadow-sm incoming-form-card">
                        ...
                        <div class="card-header bg-transparent border-bottom">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h4 class="card-title mb-1" id="formTitle">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="incomingForm" method="POST" action="{{ route('rmpm.pm.incoming.store') }}">
                                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <select name="jenis_incoming_id" id="jenis_incoming_id"
                                            ...
                                            @foreach ($jenisIncomings as $item)
                                                <option value="{{ $item->id }}" @selected(old('jenis_incoming_id') == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div id="jenisIncomingLainnyaWrapper" class="other-inline-field d-none">
                                            <label for="jenis_incoming_lainnya" class="form-label mb-1">
                                                Jenis Incoming Lainnya
                                                <span class="text-danger">*</span>
                                            </label>

                                            <input type="text" name="jenis_incoming_lainnya"
                                                ...
                                                placeholder="Contoh: Paper Bag, Label Sticker, dll." maxlength="255">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <select name="jenis_material_id" id="jenis_material_id"
                                            ...
                                            @foreach ($jenisMaterials as $material)
                                                <option value="{{ $material->id }}" @selected(old('jenis_material_id') == $material->id)>
                                                    {{ $material->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div id="supplierLainnyaWrapper" class="other-inline-field d-none">
                                            <label for="supplier_lainnya" class="form-label mb-1">
                                                Supplier Lainnya
                                                <span class="text-danger">*</span>
                                            </label>

                                            <input type="text" name="supplier_lainnya" id="supplier_lainnya"
                                                class="form-control @error('supplier_lainnya') is-invalid @enderror"
                                                value="{{ old('supplier_lainnya') }}"
                                                placeholder="Contoh: PT ABC Packaging" maxlength="255">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="wpm-autosuggest" id="wpmAutosuggest">
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                ...
                                                <input type="text" name="mid" id="mid"
                                                    ...
                                                    value="{{ old('mid') }}"
                                                    placeholder="Ketik MID atau nama barang..." maxlength="100"
                                                    autocomplete="off" spellcheck="false" required role="combobox"
                                                    aria-autocomplete="list" aria-expanded="false"
                                                    aria-controls="wpmSuggestionList">

                                                <button type="button" class="btn btn-outline-secondary d-none"
                                                    id="btnClearMid" title="Hapus pilihan MID">
                                                    <i class="mdi mdi-close"></i>
                                                </button>
                                            </div>

                                            <div id="wpmSuggestionList" class="wpm-suggestion-panel d-none"
                                                role="listbox"></div>
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <input type="text" id="nama_barang_wpm" class="form-control bg-light"
                                            value="" placeholder="Terisi otomatis setelah MID dipilih" readonly>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <input type="text" id="uom_wpm" class="form-control bg-light"
                                            value="" placeholder="Terisi otomatis" readonly>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="quantity_incoming" id="quantity_incoming"
                                                class="form-control @error('quantity_incoming') is-invalid @enderror"
                                                value="{{ old('quantity_incoming') }}" placeholder="Masukkan quantity"
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="jumlah_sampel" id="jumlah_sampel"
                                                class="form-control @error('jumlah_sampel') is-invalid @enderror"
                                                value="{{ old('jumlah_sampel') }}" placeholder="Masukkan jumlah sampel"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="statusDefaultBox" class="status-default-box status-wide">
                                            <i id="statusDefaultIcon" class="mdi mdi-clock-outline"></i>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="keterangan" id="keterangan" class="form-control" rows="3"
                                            placeholder="Tambahkan catatan apabila diperlukan">{{ old('keterangan') }}</textarea>
                                    </div>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const wpmDirectEndpoint = @json(env('WPM_API_URL', 'http://10.11.10.130:8087/api/wpm/master-barang'));
            const wpmProxyEndpoint = @json(route('rmpm.pm.incoming.wpm-barang'));
        ...
        `;
            ...
            function updateJenisIncomingLainnya(
                ...
                jenisIncomingLainnyaInput.disabled = !isOthers;
            ...
            function updateSupplierLainnya(
                ...
                supplierLainnyaInput.disabled = !isOthers;
