...
@section('title', 'Monitoring Pasteurisasi')
@section('content')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('monitoring-pasteurisasi.index') }}",
                    data: function(d) {
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('monitoring-pasteurisasi.edit', '') }}/" + id,
                    dataType: "json",
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "{{ route('monitoring-pasteurisasi.update') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
            ...
            $('body').on('click', '#btnDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "monitoring-pasteurisasi/" + id,
                            dataType: "json",
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
