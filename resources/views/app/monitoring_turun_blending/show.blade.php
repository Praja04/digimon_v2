...
@section('title', 'Detail Monitoring Turun Blending')
@section('content')
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('monitoring-turun-blending.index') }}">Monitoring Turun
                                        Blending</a>
                                </li>
                                        ...
                                        <div class="product-content mt-5">
                                            ...
                                            <nav>
                                                <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab"
                                                    role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="nav-monitoring-turun-blending-tab"
                                                            data-bs-toggle="tab" href="#nav-monitoring-turun-blending"
                                                            role="tab" aria-controls="nav-monitoring-turun-blending"
                                                            aria-selected="true">Monitoring Turun Blending</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                            <div class="tab-content border border-top-0 p-4"
                                                id="nav-monitoring-turun-blending-content">
                                                <div class="tab-pane fade show active" id="nav-monitoring-turun-blending"
                                                    role="tabpanel" aria-labelledby="nav-monitoring-turun-blending-tab">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body text-center"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG(route('analisa.monitoring-turun-blending.show_batch', $blending->id), 'QRCODE') }}"
                                                                                                    alt="QR Code">
                                                                                            </div>
                                                                                            <p>Monitoring Turun
                                                                                                Blending/{{ $productionBatch->po_number }}/{{ $productionBatch->variant }}/{{ $blending->batch_range }}
                                                                                            </p>
                                                                                        </div>
                                                                                        <div
    ...
    <script>
        ...
        function populateBatchOptions() {
            ...
            if (!validGgasBatches || validGgasBatches.length === 0) {
                $start.append('<option disabled>Belum ada Batch yang lolos Blending Awal(Release)</option>');
                return;
            }
        ...
        $('body').on('click', '#btnRevisi', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('monitoring-turun-blending.getLastRevisi') }}",
                data: {
                ...
                success: function(res) {
                    ...
                    if (disposition === 'Leveling') {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ route('monitoring-turun-blending.getAvailableAdditionalBatch') }}",
                            data: {
                                production_batch_id: poId,
                                exclude_batch: batch
                            },
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ route('monitoring-turun-blending.getJalanBareng') }}",
                            data: {
                                production_batch_id: poId
                            },
                            dataType: "json",
        ...
        $(document).ready(function() {
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "{{ route('monitoring-turun-blending.store') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
            ...
            $('#formRevisi').submit(function(e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "{{ route('monitoring-turun-blending.storeRevisi') }}",
                    type: "POST",
                    dataType: 'json',
                    beforeSend: function() {
