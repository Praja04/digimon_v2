                                    ...
                                    <div class="mt-xl-0 mt-5">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h4>{{ $pelarutan_2->productionBatch->po_number }} (Nomor PO)</h4>
                                                <div class="hstack gap-3 flex-wrap">
                                                    ...
                                                    <div class="text-muted">Tanggal Produksi : <span
                                                            class="text-body fw-medium">{{ $pelarutan_2->productionBatch->date }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ $pelarutan_2->productionBatch->variant }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">
                                                                {{ $pelarutan_2->productionBatch->batch_range }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ $pelarutan_2->batch_number }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ $pelarutan_2->dissolver_number }}</h5>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6 mt-3">
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ !empty($pelarutan_2->suhu) ? $pelarutan_2->suhu . ' °C' : '-' }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ !empty($pelarutan_2->jam_mulai) ? \Carbon\Carbon::parse($pelarutan_2->jam_mulai)->format('d/m/Y H:i') : '-' }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4 text-muted">
                                            ...
                                            <p>{{ $pelarutan_2->productionBatch->description ?? '-' }}</p>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="brix" id="brix"
                                                ...
                                                value="{{ str_replace('.', ',', $pelarutan_2->brix ?? '') }}">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="nacl" id="nacl"
                                                class="form-control comma-input" placeholder="Contoh: 0,00"
                                                value="{{ str_replace('.', ',', $pelarutan_2->nacl ?? '') }}">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="visco" id="visco"
                                                class="form-control comma-input" placeholder="Contoh: 0,00"
                                                value="{{ str_replace('.', ',', $pelarutan_2->visco ?? '') }}">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <select name="status_disposition" id="status_disposition"
                                                ...
                                                <option value="OK"
                                                    {{ $pelarutan_2->status == 'OK' ? 'selected' : '' }}>OK
                                                </option>
                                                <option value="NOT OK"
                                                    {{ $pelarutan_2->status == 'NOT OK' ? 'selected' : '' }}>
                                                    NOT OK</option>
                                            </select>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="disposition_remark" class="form-control" rows="2" placeholder="Isi catatan jika diperlukan..."
                                                oninput="this.value = this.value.toUpperCase();">{{ $pelarutan_2->disposition_remark ?? '' }}</textarea>
                                        </div>
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            window.location.href =
                                "{{ route('pelarutan-2.show', '') }}/" +
                                {{ $pelarutan_2->productionBatch->id }}
                        });
                    },
                    error: function(xhr) {
