                    ...
                    >
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Kelola master Jenis Incoming Packaging Material.
                            </p>
                        </div>
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            class="form-control"
                            maxlength="100"
                            placeholder="Masukkan nama jenis incoming"
                        >
                        ...
                        <small class="text-muted">
                            Contoh: Inner / Outer, Kardus, atau Others.
                        </small>
...
<script>
    $(document).ready(function () {
        ...
        const modalJenisIncoming = new bootstrap.Modal(
            modalElement
        );
        ...
        const table = $('#datatable').DataTable({
            ...
            language: {
                ...
                emptyTable: 'Data Jenis Incoming belum tersedia',
