                    ...
                    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Kelola master satuan Packaging Material.
                            </p>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        const modalUom = new bootstrap.Modal(
            modalElement
        );
        ...
        const table = $('#datatable').DataTable({
            ...
            language: {
                ...
                emptyTable: 'Data UOM belum tersedia',
        ...
        $('#formUom').on('submit', function (event) {
