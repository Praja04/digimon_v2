    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['rmpm.index', 'rmpm.show']) ? 'active' : '' }}" href="{{ route('rmpm.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['pelarutan-1.menu', 'pelarutan-1.index', 'pelarutan-1.show', 'pelarutan-1.show_batch', 'pelarutan-2.index', 'pelarutan-2.show', 'pelarutan-2.show_batch']) ? 'active' : '' }}" href="{{ route('pelarutan-1.menu') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['analisa.blending-awal.menu', 'analisa.blending-awal.index', 'analisa.blending-awal.show', 'analisa.blending-awal.show_batch', 'analisa.blending-awal-mikro.index', 'analisa.blending-awal-mikro.show', 'analisa.blending-awal-mikro.show_batch']) ? 'active' : '' }}" href="{{ route('analisa.blending-awal.menu') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['monitoring-daily-tank.menu', 'monitoring-daily-tank.index', 'monitoring-daily-tank.show', 'analisa.monitoring-daily-tank-mikro.show', 'analisa.monitoring-daily-tank-kimia.show', 'monitoring-ongoing-kimia.index', 'monitoring-ongoing-mikro.index', 'monitoring-ongoing-kimia.show', 'monitoring-ongoing-kimia.analisa', 'monitoring-ongoing-mikro.analisa']) ? 'active' : '' }}" href="{{ route('monitoring-daily-tank.menu') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['shelf-life.index', 'shelf-life.sample.index', 'shelf-life.sample.show', 'shelf-life.checksheet.index', 'shelf-life.analysis-kimia.index', 'shelf-life.analysis-kimia.show', 'shelf-life.analysis-mikro.index', 'shelf-life.analysis-mikro.show', 'shelf-life.result.index']) ? 'active' : '' }}" href="{{ route('shelf-life.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['press-test-data.index']) ? 'active' : '' }}" href="{{ route('press-test-data.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['scan.*']) ? 'active' : '' }}" href="{{ route('scan.index') }}">
                ...
                @if (in_array($userRole, ['Head Of Dapartement', 'Supervisor', 'Foreman']))
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['notifications.*']) ? 'active' : '' }}" href="{{ route('notifications.index') }}">
                ...
                {{-- Profile Menu: All --}}
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['profile.index']) ? 'active' : '' }}" href="{{ route('profile.index') }}">
                ...
                @if ($userRole === 'Foreman')
                <li class="nav-item">
                    <a class="nav-link menu-link {{ request()->routeIs(['colors.*']) ? 'active' : '' }}" href="{{ route('colors.index') }}">
