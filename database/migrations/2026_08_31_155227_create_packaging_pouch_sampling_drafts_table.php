...
return new class extends Migration
{
    ...
    {
        Schema::create('packaging_pouch_sampling_drafts', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(
                ...
                'pouch_draft_incoming_unique'
            );

            $table->foreign(
                'packaging_incoming_id',
                'pouch_draft_incoming_fk'
            )
                ->references('id')
